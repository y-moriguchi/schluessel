 ...
 */
public class OpenHttpInputPort extends Subr {
	...
	public Datum eval(Datum body, Environment env, LispMessage mesg) {
		try {
			...
			Datum cn = SubrUtils.nextIf(itr, mesg, body);
			...
			if(!(cn instanceof LispHttpConnection)) {
				...
				con = ((LispHttpConnection)cn).connection;
