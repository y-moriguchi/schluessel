...
import net.morilib.lisp.r6rs.fixnum.AbstractFixnumUnaryArgs;
 ...
 */
public class FixnumToFlonum extends AbstractFixnumUnaryArgs {
	...
	protected Datum execute(int x, Environment env, LispMessage mesg) {
		return FlonumUtils.flonum((double)x);
	}
