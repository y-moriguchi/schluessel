 ...
 */
public abstract class AbstractFixnumBinaryOp extends BinaryArgs {
	 ...
	 * @return
	 */
	protected abstract int execute(int x, int y, LispMessage mesg);
	...
	protected Datum execute(Datum c1a, Datum c2a,
		...
		return LispInteger.valueOf(execute(
				SubrUtils.getSmallInt(c1a, mesg),
				SubrUtils.getSmallInt(c2a, mesg), mesg));
	}
