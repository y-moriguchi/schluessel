 ...
 */
public abstract class AbstractFixnumUnaryArgs extends UnaryArgs {
	 ...
	 * @return
	 */
	protected abstract Datum execute(int x, Environment env,
			LispMessage mesg);
	...
	protected Datum execute(Datum c1a, Environment env,
			LispMessage mesg) {
		return execute(SubrUtils.getSmallInt(c1a, mesg), env, mesg);
	}
