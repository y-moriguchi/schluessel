 ...
 */
public abstract class AbstractFixnumBinaryOp3 extends BinaryArgs {
	 ...
	 * @return
	 */
	protected abstract int op1(int x, int y, LispMessage mesg);
	...
	protected Datum execute(Datum c1a, Datum c2a,
		...
		return MultiValues.newValues(
				LispInteger.valueOf(op1(x, y, mesg)),
				LispInteger.valueOf(op2(x, y, mesg)));
	}
