 ...
 */
public abstract class AbstractFixnumTernaryOp3 extends TernaryArgs {
	 ...
	 * @return
	 */
	protected abstract int op1(int x, int y, int z, LispMessage mesg);
	 ...
	 * @return
	 */
	protected abstract int op2(int x, int y, int z, LispMessage mesg);
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a,
		...
		return MultiValues.newValues(
				LispInteger.valueOf(op1(x, y, z, mesg)),
				LispInteger.valueOf(op2(x, y, z, mesg)));
	}
