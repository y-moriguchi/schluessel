 ...
 */
public class LispLatin1Codec extends Datum2 implements ILispCodec {

	/**
	 * 
	 */
	public static final LispLatin1Codec INSTANCE =
		new LispLatin1Codec();
	...
	public InputTranscoder newInput(InputStream ins, LispEolStyle eol,
		...
		return eol.getInputTranscoder(new Latin1InputTranscoder(ins));
	}
