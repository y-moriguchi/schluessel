 ...
 */
public class LispUTF16Codec extends Datum2 implements ILispCodec {

	/**
	 * 
	 */
	public static final LispUTF16Codec INSTANCE = new LispUTF16Codec();
	...
	public InputTranscoder newInput(InputStream ins, LispEolStyle eol,
		...
		return eol.getInputTranscoder(
				new UTF16InputTranscoder(ins, mode));
	}
	...
	public OutputTranscoder newOutput(OutputStream ous,
			LispEolStyle eol,
			LispErrorHandlingMode mode) throws IOException {
		return eol.getOutputTranscoder(new UTF16OutputTranscoder(
				ous, mode, UTF16.BIG_ENDIAN));
	}
