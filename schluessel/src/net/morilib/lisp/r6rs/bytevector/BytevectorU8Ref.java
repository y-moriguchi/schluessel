 ...
 */
public class BytevectorU8Ref extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
			LispMessage mesg) {
		LispBytevector v = LispBytevector.datumToBytevector(c1a, mesg);
		...
		return LispInteger.valueOf(((b = v.get(k)) < 0) ? b + 256 : b);
	}
