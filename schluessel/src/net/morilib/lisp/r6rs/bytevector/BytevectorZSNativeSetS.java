 ...
 */
public abstract class BytevectorZSNativeSetS
extends BytevectorNNativeSetS {
	...
	protected LispReal checkNumber(Datum r, LispMessage mesg) {
		...
		BigInteger z = i.getBigInteger();
		BigInteger m = BigInteger.ONE.shiftLeft(getSize() * 8 - 1);

		if(z.compareTo(m.negate()) < 0) {
