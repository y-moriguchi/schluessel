 ...
 */
public class ExtractCondition extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		} else if(!(c2a instanceof LispConditionType)) {
			throw mesg.getError(
					"err.condition.require.conditiontype", c2a);
		} else {
			Datum d = ((LispCondition)c1a).extractCondition(
					(LispConditionType)c2a);
