 ...
 */
public class BindLdapService extends TernaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a,
		...
		String hn = SubrUtils.getString(c1a, mesg);
		String dn = SubrUtils.getString(c2a, mesg);
		String pw = SubrUtils.getString(c3a, mesg);

		try {
			return new LispLDAPService(new LDAPManager(hn, dn, pw));
