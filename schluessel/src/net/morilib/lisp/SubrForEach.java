...
public class SubrForEach extends Subr {
	...
	/*package*/ ClosureClass createClosureClass(Environment env) {
		...
		bld.addPop();
		//bld.addPush(env.findDatum(new Symbol("cons")));
		//bld.addBeginList();
		...
		//bld.addAppendList();
		//bld.addReferSymbol(new Symbol("res"));
		//bld.addAppendList();
		//bld.addEndList();
		//bld.addCall();
		//bld.addBind(new Symbol("res"));
		bld.addPop();
		...
		bld.addPop();
		//bld.addPush(env.findDatum(new Symbol("reverse")));
		//bld.addBeginList();
		//bld.addReferSymbol(new Symbol("res"));
		//bld.addAppendList();
		//bld.addEndList();
