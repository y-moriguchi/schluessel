 ...
 */
public class SubtractDuration extends BinaryArgs {
	...
	protected Datum execute(
		...
		t1 = (LispTime)c1a;
		t2 = (LispTime)c2a;
		if(!t2.getTimeType().equals(LispTime.TimeType.TIME_DURATION)) {
			throw mesg.getError("err.srfi19.invalidtimetype");
		}
