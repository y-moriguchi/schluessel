 ...
 */
public class ConsTensorProduct extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		} else if(!(c2a instanceof ILispVector)) {
			throw mesg.getError("err.require.vector", c2a);
		} else {
			return LispMatrices.consTensorProduct(
					(ILispVector)c1a, (ILispVector)c2a);
		}
	}
