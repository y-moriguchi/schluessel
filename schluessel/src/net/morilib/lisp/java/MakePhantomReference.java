 ...
 */
public class MakePhantomReference extends Subr {
	...
	public Datum eval(Datum body, Environment env, LispMessage mesg) {
		...
		if(d2 instanceof LispReferenceQueue) {
			return new LispWeakReference(new PhantomReference<Datum>(
					d1, ((LispReferenceQueue)d2).queue));
		} else {
