 ...
 */
public class LispArrayS32 extends SRFI47Array
implements java.io.Serializable {
	 ...
	 * @author MORIGUCHI, Yuichiro 2011/05/23
	 */
	public static class As32 extends Subr {
	...
	implements LispArrayPrototype {
		...
		public ILispArray makeArray(int... is) {
			return new LispArrayS32(real, is);
		}
	 ...
	 * @param is
	 */
	public LispArrayS32(int r, int... is) {
		super(is);
	...
	public LispVector toVector() {
		...
		for(int i = 0; i < r.length; i++) {
			r[i] = LispInteger.valueOf(real[i]);
		}
	...
	public Datum getFromArray(int... is) {
		return LispInteger.valueOf(real[LispArrayShape.arrayindex(
				eIndices, is)]);
	}
	...
	public boolean isEqualTo(ILispArray a) {
		if(!isIndexEqualTo(a)) {
			return false;
		} else if(a instanceof LispArrayS32) {
			return Arrays.equals(real, ((LispArrayS32)a).real);
		} else {
