 ...
 */
public class LispArrayR32 extends SRFI47Array
implements java.io.Serializable {
	 ...
	 * @author MORIGUCHI, Yuichiro 2011/05/23
	 */
	public static class Ar32 extends Subr {
	...
	implements LispArrayPrototype {
		...
		public ILispArray makeArray(int... is) {
			return new LispArrayR32(real, is);
		}
	 ...
	 * @param is
	 */
	public LispArrayR32(float r, int... is) {
		super(is);
	...
	public Datum getFromArray(int... is) {
		return new LispFloat(real[LispArrayShape.arrayindex(
				eIndices, is)]);
	}
	...
	public void setToArray(Datum d, int... is) {
		if(!(d instanceof LispReal)) {
			...
			real[LispArrayShape.arrayindex(
					eIndices, is)] = (float)d.getRealDouble();
		}
	}
	...
	public boolean isEqualTo(ILispArray a) {
		if(!isIndexEqualTo(a)) {
			return false;
		} else if(a instanceof LispArrayR32) {
			return Arrays.equals(real, ((LispArrayR32)a).real);
		} else {
