 ...
 */
public class LispArrayR64 extends SRFI47Array
implements java.io.Serializable {
	 ...
	 * @author MORIGUCHI, Yuichiro 2011/05/23
	 */
	public static class Ar64 extends Subr {
	...
	implements LispArrayPrototype {
		...
		public ILispArray makeArray(int... is) {
			return new LispArrayR64(real, is);
		}
	...
	public LispArrayR64(double r, int... is) {
		super(is);
		real     = new double[LispArrayShape.arraylength(is)];
		Arrays.fill(real, r);
	}
	...
	public Datum getFromArray(int... is) {
		return new LispDouble(real[LispArrayShape.arrayindex(
				eIndices, is)]);
	}
	...
	public boolean isEqualTo(ILispArray a) {
		if(!isIndexEqualTo(a)) {
			return false;
		} else if(a instanceof LispArrayR64) {
			return Arrays.equals(real, ((LispArrayR64)a).real);
		} else {
