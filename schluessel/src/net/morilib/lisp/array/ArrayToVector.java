...
public class ArrayToVector extends UnaryArgs {
	...
	//
	private static Datum tovec(ILispArray a, int dp, int[] is) {
		if(is.length == dp) {
	 ...
	 * @return
	 */
	public static Datum toVector(ILispArray a) {
		return tovec(a, 0, new int[a.rank()]);
	}
	...
	protected Datum execute(Datum c1a, Environment env,
		...
		if(c1a instanceof ILispArray) {
			return toVector((ILispArray)c1a);
		} else {
