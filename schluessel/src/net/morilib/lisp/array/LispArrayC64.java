...
implements java.io.Serializable {
	...
	implements LispArrayPrototype {
		...
		public ILispArray makeArray(int... is) {
			return new LispArrayC64(real, imag, is);
		}
	...
	public LispArrayC64(double r, double i, int... is) {
		...
		imag     = new double[LispArrayShape.arraylength(is)];
		Arrays.fill(real, r);
		Arrays.fill(imag, i);
	}
	...
	public void setToArray(Datum d, int... is) {
		if(!(d instanceof LispComplex)) {
			...
			real[p] = n.getRealDouble();
			imag[p] = n.getImagDouble();
		}
	}
	...
	public boolean isEqualTo(ILispArray a) {
		if(!isIndexEqualTo(a)) {
			return false;
		} else if(a instanceof LispArrayC64) {
			return (Arrays.equals(real, ((LispArrayC64)a).real) &&
					Arrays.equals(imag, ((LispArrayC64)a).imag));
		} else {
