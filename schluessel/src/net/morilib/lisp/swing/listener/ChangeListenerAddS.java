 ...
 */
public class ChangeListenerAddS extends BinaryArgs {
	...
	protected Datum execute(
		...
		if(!(c1a instanceof ChangeListenable)) {
			throw mesg.getError(
					"err.swing.require.listener.action", c1a);
		} else if(!(c2a instanceof Procedure)) {
			throw mesg.getError("err.require.procedure", c2a);
		}

		b = (ChangeListenable)c1a;
		b.addChangeListener(LispSwing.createChangeListener(
				c2a, env, mesg));
		return Undef.UNDEF;
	}
