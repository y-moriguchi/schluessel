 ...
 */
public class ItemListenerAddS extends BinaryArgs {
	...
	protected Datum execute(
		...
		if(!(c1a instanceof ItemListenable)) {
			throw mesg.getError(
					"err.swing.require.listener.item", c1a);
		} else if(!(c2a instanceof Procedure)) {
			throw mesg.getError("err.require.procedure", c2a);
		}

		b = (ItemListenable)c1a;
		b.addItemListener(LispSwing.createItemListener(
				c2a, env, mesg));
		return Undef.UNDEF;
	}
