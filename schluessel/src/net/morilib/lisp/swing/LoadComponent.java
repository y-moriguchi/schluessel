 ...
 */
public class LoadComponent extends Subr {
	...
	public Datum eval(Datum body, Environment env, LispMessage mesg) {
		...
		if(d instanceof ILispLoadableComponent) {
			try {
				((ILispLoadableComponent)d).load(
			...
			throw mesg.getError("err.swing.require.component.import",
					d);
		}
	}
