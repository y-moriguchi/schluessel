 ...
 */
public class JtreePathListForLocation extends TernaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a,
		...
		if(c1a instanceof LispJTree) {
			path = ((LispJTree)c1a).tree.getPathForLocation(x, y);
			if(path == null)  return LispBoolean.FALSE;
			for(Object o : path.getPath()) {
				l.add((Datum)((MyMutableTreeNode)o).getUserObject());
			}
			return LispUtils.listToCons(l);
		} else {
