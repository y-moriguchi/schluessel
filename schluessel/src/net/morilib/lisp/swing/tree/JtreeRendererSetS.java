 ...
 */
public class JtreeRendererSetS extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		if(!(c1a instanceof LispJTree)) {
			...
			r = new DefaultTreeCellRenderer();
		} else if(c2a instanceof Procedure) {
			r = new MyLispRenderer(env, (Procedure)c2a, mesg);
		} else {
			throw mesg.getError("err.require.procedure", c2a);
		}
		((LispJTree)c1a).tree.setCellRenderer(r);
		return Undef.UNDEF;
	}
