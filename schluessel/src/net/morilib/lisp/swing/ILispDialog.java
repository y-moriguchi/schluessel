...
import net.morilib.lisp.swing.listener.WindowListenable;
...
public interface ILispDialog extends WindowListenable {
	...
	public static class SetDialogResizableS extends BinaryArgs {
		...
		protected Datum execute(
				...
				LispMessage mesg) {
			if(c1a instanceof ILispDialog) {
				((ILispDialog)c1a).getDialog().setResizable(
						c2a.isTrue());
				return Undef.UNDEF;
			} else {
				throw mesg.getError("err.swing.require.dialog", c1a);
			}
		}
