 ...
 */
public abstract class PointSizeDrawer implements Drawer {
	...
	public void draw(
		...
		if(coordinate != null) {
			...
			MutablePoint2D p2 = coordinate.transformSize(
					framex, framey, x2 - x1, y1 - y2);
			
			draw1(g, p1.getXInt(), p1.getYInt(),
					p2.getXInt(), p2.getYInt());
		} else {
			draw1(g, (int)x1, (int)y1,
					(int)(x2 - x1), (int)(y2 - y1));
		}
	}
