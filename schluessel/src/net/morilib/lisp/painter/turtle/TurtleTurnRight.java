 ...
 */
public class TurtleTurnRight extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
			LispMessage mesg) {
		double t = SubrUtils.getDouble(c2a, mesg);

		if(c1a instanceof LispTurtle) {
			((LispTurtle)c1a).drawer.addTurnLeftByDegree(-t);
