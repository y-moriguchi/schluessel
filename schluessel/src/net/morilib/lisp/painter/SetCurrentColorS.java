...
import net.morilib.lisp.painter.drawer.SetColorDrawer;
 ...
 */
public class SetCurrentColorS extends BinaryArgs {
	...
	protected Datum execute(
		...
		((SchlushFrame)c1a).addDrawer(
				new SetColorDrawer(((SchlushColor)c2a).color));
		return Undef.UNDEF;
	}
