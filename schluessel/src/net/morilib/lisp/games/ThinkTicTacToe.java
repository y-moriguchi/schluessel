 ...
 */
public class ThinkTicTacToe extends UnaryArgs {
	...
	protected Datum execute(Datum c1a, Environment env,
		...
		if(c1a instanceof LispTicTacToeBoard) {
			r = TicTacToe.think(((LispTicTacToeBoard)c1a).board);
			if(r >= 0) {
				return new LispTicTacToeBoard(r);
			} else if(r == TicTacToe.O_WIN) {
				return Symbol.getSymbol("o-win");
			} else if(r == TicTacToe.X_WIN) {
				return Symbol.getSymbol("x-win");
			} else if(r == TicTacToe.EVEN) {
