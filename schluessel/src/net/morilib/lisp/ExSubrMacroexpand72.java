 ...
 *
 *
 * @author MORIGUCHI, Yuichiro 2012/03/09
 */
public class ExSubrMacroexpand72 extends Subr
implements ILispDynamicSubr {
	...
	/*package*/ ClosureClass createClosureClass(Environment env) {
		...
		bld.addReferSymbol(Symbol.getSymbol("env"));
		bld.addExpandMacro72();
		bld.addReturnOp();

		cl1.setParameterList(LispUtils.list(
				Symbol.getSymbol("f"), Symbol.getSymbol("env")));
