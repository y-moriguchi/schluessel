 ...
 */
public class ImplementationVicinity extends NoArgs {
...
//		Set<String> fs = Vicinity.CLASSPATH;
//		ClassLoader cl;
//		File fl;
//		URL ur;
...
//				fl = new File(s);
//				ur = fl.toURI().toURL();
//				cl = URLClassLoader.newInstance(new URL[] { ur });
//				Class.forName("net.morilib.lisp.Scheme", false, cl);
//				return new LispVicinity(fl);
