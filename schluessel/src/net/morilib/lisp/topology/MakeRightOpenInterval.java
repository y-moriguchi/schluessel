 ...
 */
public class MakeRightOpenInterval extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
			LispMessage mesg) {
		LispReal r1 = SubrUtils.getReal(c1a, mesg);
		LispReal r2 = SubrUtils.getReal(c2a, mesg);

		if(r1.compareTo(r2) >= 0) {
			throw mesg.getError("err.range.invalid");
		} else {
			return new LispRealNumberSet(
					Intervals.newRightOpenInterval(r1, r2));
		}
	}
