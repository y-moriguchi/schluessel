 ...
 */
public class AddGraphEdge extends QuaternaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a, Datum c4a,
		...
		if(c1a instanceof ILispGraph) {
			try {
				((ILispGraph)c1a).addEdge(c2a, c3a, c4a);
				return Undef.UNDEF;
			} catch(UnsupportedOperationException e) {
				throw mesg.getError("err.graph.immutable");
			}
		} else {
			throw mesg.getError("err.graph.require.graph", c1a);
		}
	}
