 ...
 */
public class IntegerCompare extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		} else if(c1a instanceof LispSmallInt &&
				c2a instanceof LispSmallInt) {
			return SRFI67.compareInt(c1a.getInt(), c2a.getInt());
		} else {
			return SRFI67.compareTo(c1a.getBigInteger(),
					c2a.getBigInteger());
		}
	}
