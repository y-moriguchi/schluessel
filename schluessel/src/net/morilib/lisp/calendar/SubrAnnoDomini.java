...
import net.morilib.calendar.AnnoDomini;
 ...
 */
public class SubrAnnoDomini extends TernaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a,
		...
		int y = SubrUtils.getSmallInt(c1a, mesg);
		int m = SubrUtils.getSmallInt(c2a, mesg);
		int d = SubrUtils.getSmallInt(c3a, mesg);

		try {
			return new LispDay(new AnnoDomini(y, m, d));
