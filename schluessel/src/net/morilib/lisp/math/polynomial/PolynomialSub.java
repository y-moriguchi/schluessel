...
public class PolynomialSub extends PolynomialOperator2 {
	...
	/* (non-Javadoc)
	 * @see net.morilib.lisp.math.PolynomialOperator2#calculateUnary(net.morilib.lisp.math.LispPolynomial)
	 */
	@Override
	protected LispPolynomial calculateUnary(LispPolynomial o1) {
		return new LispPolynomial(o1.getPoly().negate());
	}
	...
	protected LispPolynomial calculate(
		...
		return new LispPolynomial(
				o1.getPoly().subtract(o2.getPoly()));
	}
