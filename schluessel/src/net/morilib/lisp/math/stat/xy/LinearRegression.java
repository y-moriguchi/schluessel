...
import net.morilib.lisp.math.polynomial1.LispPolynomial1;
 ...
 */
public class LinearRegression extends SubrXyProperties {
	...
	protected Datum lispXy(ILispXYData dx) {
		double[] rg = dx.regression();

		return LispPolynomial1.newInstance(rg[0], rg[1]);
	}
	...
	protected Datum statdouble(double[] x, double[] y) {
		double[] rg = StatisticsUtils.regression(x, y);
