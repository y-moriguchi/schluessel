...
import net.morilib.math.stat.dist.continuous.ExponentialDistribution;
 ...
 */
public class LispExponentialDistribution extends AbstractLispDistribution {
	 ...
	 * @param d
	 */
	public LispExponentialDistribution(double lambda) {
	...
	public void toDisplayString(StringBuilder buf) {
		buf.append("#<exponential-distribution(");
