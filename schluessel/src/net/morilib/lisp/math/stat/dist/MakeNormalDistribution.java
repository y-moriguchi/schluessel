 ...
 */
public class MakeNormalDistribution extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		mean = SubrUtils.getDouble(c1a, mesg);
		if((variance = SubrUtils.getDouble(c2a, mesg)) <= 0.0) {
			throw mesg.getError("err.require.real.positive", c2a);
		} else {
			return new LispNormalDistribution(mean, variance);
		}
	}
