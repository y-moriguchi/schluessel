 ...
 */
public class DistributionPGt extends BinaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Environment env,
		...
		if(c1a instanceof ILispDistribution) {
			x = SubrUtils.getDouble(c2a, mesg);
			return new LispDouble(1.0 - ((ILispDistribution)
					c1a).getDistribution().cdf(x));
		} else {
