 ...
 */
public class LispTDistribution extends AbstractLispDistribution {
	 ...
	 * @param nu
	 */
	public LispTDistribution(double nu) {
		dist = new TDistribution(nu);
	}
	...
	public void toDisplayString(StringBuilder buf) {
		buf.append("#<t(").append(dist.getNu()).append(")>");
	}
