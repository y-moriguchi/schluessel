 ...
 */
public class LispHarmonicSequence extends AbstractLispRealSequence {
	...
	public LispHarmonicSequence(LispReal a1, LispReal d, int size) {
		...
		} else if(d.negate().invert().isInteger()) {
	...
	public LispReal get(int i) {
		...
		return a1.divide(d.multiply(i - 1).add(LispInteger.ONE));
	}
	...
	public ILispSequence inv() {
		return new LispArithmeticSequence(
