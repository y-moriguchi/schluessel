 ...
 */
public class Permutation extends Subr {
	...
	public Datum eval(Datum body, Environment env, LispMessage mesg) {
		...
		IntegerVector a = new IntegerArrayVector();

		while(itr.hasNext()) {
			a.add(SubrUtils.getSmallInt(itr.next(), mesg));
		}
		SubrUtils.checkTerminated(itr, body, mesg);
		return new LispPermutation(a.toIntArray());
	}
