 ...
 */
public class MakeCustomIterator extends TernaryArgs {
	...
	protected Datum execute(Datum c1a, Datum c2a, Datum c3a,
		...
		Procedure nil, car, cdr;

		nil = SubrUtils.getProcedure(c1a, mesg);
		car = SubrUtils.getProcedure(c2a, mesg);
		cdr = SubrUtils.getProcedure(c3a, mesg);
		return new LispCustomIterator(nil, car, cdr, env, mesg);
	}
