 ...
 */
package net.morilib.lisp.console;
 ...
 */
public class ConsoleReadPassword extends NoArgs {
	...
	protected Datum execute(Environment env, LispMessage mesg) {
		...
		if((con = System.console()) == null) {
			throw mesg.getError("err.console.invalid");
		} else if((chs = con.readPassword()) == null) {
			return LispBoolean.FALSE;
		} else {
			return new LispString(new String(chs));
		}
	}
