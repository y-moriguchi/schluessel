 ...
 */
public class DfaToBasicRegex extends UnaryArgs {
	...
	protected Datum execute(Datum c1a, Environment env,
		...
		if(c1a instanceof ILispDatumDfa) {
			e = DFAs.convertToRegex(((ILispDatumDfa)c1a).getDFA());
			return new LispBasicRegex(e);
		} else {
			throw mesg.getError("err.automata.require.dfa.datum", c1a);
		}
	}
