...
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(long key, long value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(long k, Long v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public LongLongHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public LongLongHashMap(LongLongMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<LongLongMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
	...
	//
	private boolean _putEntry(long k, Long v) {
		int h = getHash(k) % ent.length;
