...
implements FloatIntegerMap {
	...
	public Set<Entry<Float, Integer>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Float, Integer>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Integer>> floatKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(FloatMap<Integer> map) {
		Iterator<FloatMap.PrimitiveEntryK<Integer>> i;
		
		i = map.floatKeyEntrySet().iterator();
		while(i.hasNext()) {
			FloatMap.PrimitiveEntryK<Integer> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Float>> intValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(IntegerValueMap<Float> map) {
		Iterator<IntegerValueMap.PrimitiveEntryV<Float>> i;
		
		i = map.intValueEntrySet().iterator();
		while(i.hasNext()) {
			IntegerValueMap.PrimitiveEntryV<Float> e = i.next();
	...
	public Integer put(Float key, Integer value) {
		return putElement(key.floatValue(), value.intValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof FloatIntegerMap) {
			FloatIntegerMap m = (FloatIntegerMap)obj;
			Iterator<PrimitiveEntry> i;
