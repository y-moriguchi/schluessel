 ...
 */
public class IntegerLongHashMap
extends AbstractIntegerLongMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(int key, long value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(int k, Long v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public IntegerLongHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public IntegerLongHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public IntegerLongHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public IntegerLongHashMap(IntegerLongMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<IntegerLongMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.IntegerLongMap#getElement(int)
	 */
	public long f(int k) {
		return _get(k).value;
	}
	...
	//
	private boolean _putEntry(int k, Long v) {
		int h = getHash(k) % ent.length;
