...
extends AbstractDoubleDoubleMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(double key, double value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(double k, Double v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public DoubleDoubleHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public DoubleDoubleHashMap(DoubleDoubleMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<DoubleDoubleMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
	...
	//
	private boolean _putEntry(double k, Double v) {
		int h = getHash(k) % ent.length;
