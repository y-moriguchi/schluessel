 ...
 */
public class IntegerFloatHashMap
extends AbstractIntegerFloatMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(int key, float value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(int k, Float v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public IntegerFloatHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public IntegerFloatHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public IntegerFloatHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public IntegerFloatHashMap(IntegerFloatMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<IntegerFloatMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return IntegerFloatHashMap.this.size();
				}
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.IntegerFloatMap#getElement(int)
	 */
	...
	//
	private boolean _putEntry(int k, Float v) {
		int h = getHash(k) % ent.length;
