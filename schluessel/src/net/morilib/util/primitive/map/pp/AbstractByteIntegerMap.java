...
implements ByteIntegerMap {
	...
	public Set<Entry<Byte, Integer>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Byte, Integer>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Integer>> byteKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(ByteMap<Integer> map) {
		Iterator<ByteMap.PrimitiveEntryK<Integer>> i;
		
		i = map.byteKeyEntrySet().iterator();
		while(i.hasNext()) {
			ByteMap.PrimitiveEntryK<Integer> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Byte>> intValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(IntegerValueMap<Byte> map) {
		Iterator<IntegerValueMap.PrimitiveEntryV<Byte>> i;
		
		i = map.intValueEntrySet().iterator();
		while(i.hasNext()) {
			IntegerValueMap.PrimitiveEntryV<Byte> e = i.next();
	...
	public Integer put(Byte key, Integer value) {
		return putElement(key.byteValue(), value.intValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ByteIntegerMap) {
			ByteIntegerMap m = (ByteIntegerMap)obj;
			Iterator<PrimitiveEntry> i;
