 ...
 */
public class CharacterDoubleHashMap
extends AbstractCharacterDoubleMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(char key, double value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(char k, Double v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public CharacterDoubleHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public CharacterDoubleHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public CharacterDoubleHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public CharacterDoubleHashMap(CharacterDoubleMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<CharacterDoubleMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return CharacterDoubleHashMap.this.size();
				}
	...
	//
	private boolean _putEntry(char k, Double v) {
		int h = getHash(k) % ent.length;
	...
	public Double removeElement(char k) {
		...
		return (r != null) ? (Double)r.value : null;
	}
