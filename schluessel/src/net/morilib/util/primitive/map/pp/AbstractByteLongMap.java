...
implements ByteLongMap {
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.ByteLongMap#getElement(byte)
	 */
	...
	public Set<Entry<Byte, Long>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Byte, Long>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Long>> byteKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(ByteMap<Long> map) {
		Iterator<ByteMap.PrimitiveEntryK<Long>> i;
		
		i = map.byteKeyEntrySet().iterator();
		while(i.hasNext()) {
			ByteMap.PrimitiveEntryK<Long> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Byte>> longValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(LongValueMap<Byte> map) {
		Iterator<LongValueMap.PrimitiveEntryV<Byte>> i;
		
		i = map.longValueEntrySet().iterator();
		while(i.hasNext()) {
			LongValueMap.PrimitiveEntryV<Byte> e = i.next();
	 ...
	 */
	public Long put(Byte key, Long value) {
		return putElement(key.byteValue(), value.longValue());
	}
