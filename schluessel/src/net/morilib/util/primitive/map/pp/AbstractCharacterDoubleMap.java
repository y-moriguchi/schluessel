 ...
 */
public abstract class AbstractCharacterDoubleMap
implements CharacterDoubleMap {
	...
	private transient Set<Map.Entry<Character, Double>> entrySet  = null;
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.CharacterDoubleMap#getElement(char)
	 */
	...
	private class KSet extends AbstractCharacterSet {
		...
		public int size() {
			return AbstractCharacterDoubleMap.this.size();
		}
		...
		public boolean remove(Object o) {
			return AbstractCharacterDoubleMap.this.remove(o) != null;
		}

		public void clear() {
			AbstractCharacterDoubleMap.this.clear();
		}
	...
	public Set<Entry<Character, Double>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Character, Double>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Double>> charKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public void putAllElement(CharacterMap<Double> map) {
		Iterator<CharacterMap.PrimitiveEntryK<Double>> i;
		
		i = map.charKeyEntrySet().iterator();
		while(i.hasNext()) {
			CharacterMap.PrimitiveEntryK<Double> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Character>> doubleValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public double putElement(Character k, double v) {
		return putElement(k, v);
	}
	 ...
	 */
	public void putAllElement(DoubleValueMap<Character> map) {
		Iterator<DoubleValueMap.PrimitiveEntryV<Character>> i;
		
		i = map.doubleValueEntrySet().iterator();
		while(i.hasNext()) {
			DoubleValueMap.PrimitiveEntryV<Character> e = i.next();
	 ...
	 */
	public Double put(Character key, Double value) {
		return putElement(key.charValue(), value.doubleValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof CharacterDoubleMap) {
			CharacterDoubleMap m = (CharacterDoubleMap)obj;
			Iterator<PrimitiveEntry> i;
