 ...
 */
public class CharacterFloatHashMap
extends AbstractCharacterFloatMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(char key, float value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(char k, Float v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public CharacterFloatHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public CharacterFloatHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public CharacterFloatHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public CharacterFloatHashMap(CharacterFloatMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<CharacterFloatMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return CharacterFloatHashMap.this.size();
				}
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.CharacterFloatMap#getElement(char)
	 */
	...
	//
	private boolean _putEntry(char k, Float v) {
		int h = getHash(k) % ent.length;
	...
	public Float removeElement(char k) {
		...
		return (r != null) ? (Float)r.value : null;
	}
