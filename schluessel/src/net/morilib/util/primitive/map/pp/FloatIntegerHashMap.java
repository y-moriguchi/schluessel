 ...
 */
public class FloatIntegerHashMap
extends AbstractFloatIntegerMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(float key, int value) {
			this.key   = key;
			this.value = value;
		}
		...
		public String toString() {
			return Float.toString(key) + "=" + value;
		}
		...
		//
		private Object putEntry(float k, Integer v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public FloatIntegerHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public FloatIntegerHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public FloatIntegerHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public FloatIntegerHashMap(FloatIntegerMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<FloatIntegerMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return FloatIntegerHashMap.this.size();
				}
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.FloatIntegerMap#getElement(float)
	 */
	...
	//
	private boolean _putEntry(float k, Integer v) {
		int h = getHash(k) % ent.length;
