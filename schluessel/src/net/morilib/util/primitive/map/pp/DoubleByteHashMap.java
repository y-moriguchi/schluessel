...
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(double key, byte value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(double k, Byte v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public DoubleByteHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param loadFactor
	 */
	public DoubleByteHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public DoubleByteHashMap(DoubleByteMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<DoubleByteMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
	...
	//
	private boolean _putEntry(double k, Byte v) {
		int h = getHash(k) % ent.length;
