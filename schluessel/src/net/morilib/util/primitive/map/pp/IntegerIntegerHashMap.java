 ...
 */
public class IntegerIntegerHashMap
extends AbstractIntegerIntegerMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Object putEntry(int k, Integer v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public IntegerIntegerHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public IntegerIntegerHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public IntegerIntegerHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public IntegerIntegerHashMap(IntegerIntegerMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<IntegerIntegerMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return IntegerIntegerHashMap.this.size();
				}
	...
	//
	private boolean _putEntry(int k, Integer v) {
		int h = getHash(k) % ent.length;
