...
implements ByteDoubleMap {
	...
	public Set<Entry<Byte, Double>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Byte, Double>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Double>> byteKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(ByteMap<Double> map) {
		Iterator<ByteMap.PrimitiveEntryK<Double>> i;
		
		i = map.byteKeyEntrySet().iterator();
		while(i.hasNext()) {
			ByteMap.PrimitiveEntryK<Double> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Byte>> doubleValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(DoubleValueMap<Byte> map) {
		Iterator<DoubleValueMap.PrimitiveEntryV<Byte>> i;
		
		i = map.doubleValueEntrySet().iterator();
		while(i.hasNext()) {
			DoubleValueMap.PrimitiveEntryV<Byte> e = i.next();
	 ...
	 */
	public Double put(Byte key, Double value) {
		return putElement(key.byteValue(), value.doubleValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ByteDoubleMap) {
			ByteDoubleMap m = (ByteDoubleMap)obj;
			Iterator<PrimitiveEntry> i;
