 ...
 */
public abstract class AbstractCharacterLongMap
implements CharacterLongMap {
	...
	private transient Set<Map.Entry<Character, Long>> entrySet  = null;
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.CharacterLongMap#getElement(char)
	 */
	...
	private class KSet extends AbstractCharacterSet {
		...
		public int size() {
			return AbstractCharacterLongMap.this.size();
		}
		...
		public boolean remove(Object o) {
			return AbstractCharacterLongMap.this.remove(o) != null;
		}

		public void clear() {
			AbstractCharacterLongMap.this.clear();
		}
	...
	public Set<Entry<Character, Long>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Character, Long>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Long>> charKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public void putAllElement(CharacterMap<Long> map) {
		Iterator<CharacterMap.PrimitiveEntryK<Long>> i;
		
		i = map.charKeyEntrySet().iterator();
		while(i.hasNext()) {
			CharacterMap.PrimitiveEntryK<Long> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Character>> longValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public long putElement(Character k, long v) {
		return putElement(k, v);
	}
	 ...
	 */
	public void putAllElement(LongValueMap<Character> map) {
		Iterator<LongValueMap.PrimitiveEntryV<Character>> i;
		
		i = map.longValueEntrySet().iterator();
		while(i.hasNext()) {
			LongValueMap.PrimitiveEntryV<Character> e = i.next();
	 ...
	 */
	public Long put(Character key, Long value) {
		return putElement(key.charValue(), value.longValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof CharacterLongMap) {
			CharacterLongMap m = (CharacterLongMap)obj;
			Iterator<PrimitiveEntry> i;
