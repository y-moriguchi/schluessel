...
implements LongLongMap {
	...
	private transient Set<Map.Entry<Long, Long>> entrySet  = null;
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.LongLongMap#getElement(long)
	 */
	public Long getElement(long k) {
		return f(k);
	}
	...
	private class KSet extends AbstractLongSet {
		...
		public boolean remove(Object o) {
			return AbstractLongLongMap.this.remove(o) != null;
		}
	 ...
	 */
	public void putAllElement(LongLongMap map) {
	...
	public Set<Entry<Long, Long>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Long, Long>>() {
	 ...
	 */
	public Long removeElement(long k) {
		Iterator<PrimitiveEntry> i;
	 ...
	 */
	public Set<PrimitiveEntryK<Long>> longKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public Long putElement(long k, Long v) {
	 ...
	 */
	public void putAllElement(LongMap<Long> map) {
		Iterator<LongMap.PrimitiveEntryK<Long>> i;
		
		i = map.longKeyEntrySet().iterator();
		while(i.hasNext()) {
			LongMap.PrimitiveEntryK<Long> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Long>> longValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public void putAllElement(LongValueMap<Long> map) {
		Iterator<LongValueMap.PrimitiveEntryV<Long>> i;
		
		i = map.longValueEntrySet().iterator();
		while(i.hasNext()) {
			LongValueMap.PrimitiveEntryV<Long> e = i.next();
	 ...
	 */
	public Long put(Long key, Long value) {
		return putElement(key.longValue(), value.longValue());
	}
