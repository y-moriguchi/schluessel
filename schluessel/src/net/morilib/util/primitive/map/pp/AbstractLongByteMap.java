...
implements LongByteMap {
	...
	public Set<Entry<Long, Byte>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Long, Byte>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Byte>> longKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(LongMap<Byte> map) {
		Iterator<LongMap.PrimitiveEntryK<Byte>> i;
		
		i = map.longKeyEntrySet().iterator();
		while(i.hasNext()) {
			LongMap.PrimitiveEntryK<Byte> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Long>> byteValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(ByteValueMap<Long> map) {
		Iterator<ByteValueMap.PrimitiveEntryV<Long>> i;
		
		i = map.byteValueEntrySet().iterator();
		while(i.hasNext()) {
			ByteValueMap.PrimitiveEntryV<Long> e = i.next();
	 ...
	 */
	public Byte put(Long key, Byte value) {
		return putElement(key.longValue(), value.byteValue());
	}
