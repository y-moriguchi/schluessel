...
implements IntegerCharacterMap {
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.IntegerCharacterMap#getElement(int)
	 */
	...
	public Set<Entry<Integer, Character>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Integer, Character>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Character>> intKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(IntegerMap<Character> map) {
		Iterator<IntegerMap.PrimitiveEntryK<Character>> i;
		
		i = map.intKeyEntrySet().iterator();
		while(i.hasNext()) {
			IntegerMap.PrimitiveEntryK<Character> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Integer>> charValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(CharacterValueMap<Integer> map) {
		Iterator<CharacterValueMap.PrimitiveEntryV<Integer>> i;
		
		i = map.charValueEntrySet().iterator();
		while(i.hasNext()) {
			CharacterValueMap.PrimitiveEntryV<Integer> e = i.next();
	...
	public Character put(Integer key, Character value) {
		return putElement(key.intValue(), value.charValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof IntegerCharacterMap) {
			IntegerCharacterMap m = (IntegerCharacterMap)obj;
			Iterator<PrimitiveEntry> i;
