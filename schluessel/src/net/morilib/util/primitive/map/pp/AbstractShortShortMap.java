 ...
 */
public abstract class AbstractShortShortMap
implements ShortShortMap {
	...
	private transient Set<PrimitiveEntryV<Short>>  entrySetV = null;
	private transient Set<Map.Entry<Short, Short>> entrySet  = null;
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.ShortShortMap#getElement(short)
	 */
	...
	private class KSet extends AbstractShortSet {
		...
		public int size() {
			return AbstractShortShortMap.this.size();
		}
		...
		public boolean remove(Object o) {
			return AbstractShortShortMap.this.remove(o) != null;
		}

		public void clear() {
			AbstractShortShortMap.this.clear();
		}
	...
	public Set<Entry<Short, Short>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Short, Short>>() {
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.po.ShortMap#shortEntrySet()
	 */
	public Set<PrimitiveEntryK<Short>> shortKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.po.ShortMap#putElement(short, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.po.ShortMap#putAllElement(net.morilib.util.primitive.map.po.ShortMap)
	 */
	public void putAllElement(ShortMap<Short> map) {
		Iterator<ShortMap.PrimitiveEntryK<Short>> i;
		
		i = map.shortKeyEntrySet().iterator();
		while(i.hasNext()) {
			ShortMap.PrimitiveEntryK<Short> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Short>> shortValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
		
		if(entrySetV == null) {
			entrySetV = new AbstractSet<PrimitiveEntryV<Short>>() {
	
				public Iterator<PrimitiveEntryV<Short>> iterator() {
					final Iterator<PrimitiveEntry> i = e.iterator();
					
					return new Iterator<PrimitiveEntryV<Short>>() {
	
						public boolean hasNext() {
							return i.hasNext();
						}
	
						public PrimitiveEntryV<Short> next() {
							final PrimitiveEntry o = i.next();
							
							return new PrimitiveEntryV<Short>() {
	 ...
	 */
	public void putAllElement(ShortValueMap<Short> map) {
		Iterator<ShortValueMap.PrimitiveEntryV<Short>> i;
		
		i = map.shortValueEntrySet().iterator();
		while(i.hasNext()) {
			ShortValueMap.PrimitiveEntryV<Short> e = i.next();
	 ...
	 */
	public Short put(Short key, Short value) {
		return putElement(key.shortValue(), value.shortValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ShortShortMap) {
			ShortShortMap m = (ShortShortMap)obj;
			Iterator<PrimitiveEntry> i;
