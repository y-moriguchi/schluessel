...
implements DoubleIntegerMap {
	...
	public Set<Entry<Double, Integer>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Double, Integer>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Integer>> doubleKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(DoubleMap<Integer> map) {
		Iterator<DoubleMap.PrimitiveEntryK<Integer>> i;
		
		i = map.doubleKeyEntrySet().iterator();
		while(i.hasNext()) {
			DoubleMap.PrimitiveEntryK<Integer> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Double>> intValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(IntegerValueMap<Double> map) {
		Iterator<IntegerValueMap.PrimitiveEntryV<Double>> i;
		
		i = map.intValueEntrySet().iterator();
		while(i.hasNext()) {
			IntegerValueMap.PrimitiveEntryV<Double> e = i.next();
	...
	public Integer put(Double key, Integer value) {
		return putElement(key.doubleValue(), value.intValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof DoubleIntegerMap) {
			DoubleIntegerMap m = (DoubleIntegerMap)obj;
			Iterator<PrimitiveEntry> i;
