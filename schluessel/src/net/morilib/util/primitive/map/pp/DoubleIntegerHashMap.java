 ...
 */
public class DoubleIntegerHashMap
extends AbstractDoubleIntegerMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(double key, int value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(double k, Integer v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public DoubleIntegerHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public DoubleIntegerHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public DoubleIntegerHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public DoubleIntegerHashMap(DoubleIntegerMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<DoubleIntegerMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return DoubleIntegerHashMap.this.size();
				}
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.DoubleIntegerMap#getElement(double)
	 */
	...
	//
	private boolean _putEntry(double k, Integer v) {
		int h = getHash(k) % ent.length;
