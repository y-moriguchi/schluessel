 ...
 */
public class IntegerShortHashMap
extends AbstractIntegerShortMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(int key, short value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(int k, Short v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public IntegerShortHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public IntegerShortHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public IntegerShortHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public IntegerShortHashMap(IntegerShortMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<IntegerShortMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return IntegerShortHashMap.this.size();
				}
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.IntegerShortMap#getElement(int)
	 */
	...
	//
	private boolean _putEntry(int k, Short v) {
		int h = getHash(k) % ent.length;
