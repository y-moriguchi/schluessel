...
implements CharacterFloatMap {
	...
	public Set<Entry<Character, Float>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Character, Float>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Float>> charKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(CharacterMap<Float> map) {
		Iterator<CharacterMap.PrimitiveEntryK<Float>> i;
		
		i = map.charKeyEntrySet().iterator();
		while(i.hasNext()) {
			CharacterMap.PrimitiveEntryK<Float> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Character>> floatValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(FloatValueMap<Character> map) {
		Iterator<FloatValueMap.PrimitiveEntryV<Character>> i;
		
		i = map.floatValueEntrySet().iterator();
		while(i.hasNext()) {
			FloatValueMap.PrimitiveEntryV<Character> e = i.next();
	 ...
	 */
	public Float put(Character key, Float value) {
		return putElement(key.charValue(), value.floatValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof CharacterFloatMap) {
			CharacterFloatMap m = (CharacterFloatMap)obj;
			Iterator<PrimitiveEntry> i;
