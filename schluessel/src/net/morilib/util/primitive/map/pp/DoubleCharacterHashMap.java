 ...
 */
public class DoubleCharacterHashMap
extends AbstractDoubleCharacterMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(double key, char value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(double k, Character v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public DoubleCharacterHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public DoubleCharacterHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public DoubleCharacterHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public DoubleCharacterHashMap(DoubleCharacterMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<DoubleCharacterMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return DoubleCharacterHashMap.this.size();
				}
	...
	//
	private boolean _putEntry(double k, Character v) {
		int h = getHash(k) % ent.length;
