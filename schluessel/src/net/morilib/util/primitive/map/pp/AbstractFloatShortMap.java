...
implements FloatShortMap {
	...
	private transient Set<Map.Entry<Float, Short>> entrySet  = null;
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.FloatShortMap#getElement(float)
	 */
	...
	private class KSet extends AbstractFloatSet {
		...
		public int size() {
			return AbstractFloatShortMap.this.size();
		}
		...
		public boolean remove(Object o) {
			return AbstractFloatShortMap.this.remove(o) != null;
		}

		public void clear() {
			AbstractFloatShortMap.this.clear();
		}
	...
	public Set<Entry<Float, Short>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Float, Short>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Short>> floatKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public void putAllElement(FloatMap<Short> map) {
		Iterator<FloatMap.PrimitiveEntryK<Short>> i;
		
		i = map.floatKeyEntrySet().iterator();
		while(i.hasNext()) {
			FloatMap.PrimitiveEntryK<Short> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Float>> shortValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	 ...
	 */
	public void putAllElement(ShortValueMap<Float> map) {
		Iterator<ShortValueMap.PrimitiveEntryV<Float>> i;
		
		i = map.shortValueEntrySet().iterator();
		while(i.hasNext()) {
			ShortValueMap.PrimitiveEntryV<Float> e = i.next();
	 ...
	 */
	public Short put(Float key, Short value) {
		return putElement(key.floatValue(), value.shortValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof FloatShortMap) {
			FloatShortMap m = (FloatShortMap)obj;
			Iterator<PrimitiveEntry> i;
