...
implements LongDoubleMap {
	...
	/* (non-Javadoc)
	 * @see net.morilib.util.primitive.map.pp.LongDoubleMap#getElement(long)
	 */
	...
	public Set<Entry<Long, Double>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Long, Double>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Double>> longKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(LongMap<Double> map) {
		Iterator<LongMap.PrimitiveEntryK<Double>> i;
		
		i = map.longKeyEntrySet().iterator();
		while(i.hasNext()) {
			LongMap.PrimitiveEntryK<Double> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Long>> doubleValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(DoubleValueMap<Long> map) {
		Iterator<DoubleValueMap.PrimitiveEntryV<Long>> i;
		
		i = map.doubleValueEntrySet().iterator();
		while(i.hasNext()) {
			DoubleValueMap.PrimitiveEntryV<Long> e = i.next();
	 ...
	 */
	public Double put(Long key, Double value) {
		return putElement(key.longValue(), value.doubleValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof LongDoubleMap) {
			LongDoubleMap m = (LongDoubleMap)obj;
			Iterator<PrimitiveEntry> i;
