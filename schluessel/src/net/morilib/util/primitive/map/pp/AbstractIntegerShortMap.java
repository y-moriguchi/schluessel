...
implements IntegerShortMap {
	...
	public Set<Entry<Integer, Short>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Integer, Short>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Short>> intKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(IntegerMap<Short> map) {
		Iterator<IntegerMap.PrimitiveEntryK<Short>> i;
		
		i = map.intKeyEntrySet().iterator();
		while(i.hasNext()) {
			IntegerMap.PrimitiveEntryK<Short> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Integer>> shortValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(ShortValueMap<Integer> map) {
		Iterator<ShortValueMap.PrimitiveEntryV<Integer>> i;
		
		i = map.shortValueEntrySet().iterator();
		while(i.hasNext()) {
			ShortValueMap.PrimitiveEntryV<Integer> e = i.next();
	 ...
	 */
	public Short put(Integer key, Short value) {
		return putElement(key.intValue(), value.shortValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof IntegerShortMap) {
			IntegerShortMap m = (IntegerShortMap)obj;
			Iterator<PrimitiveEntry> i;
