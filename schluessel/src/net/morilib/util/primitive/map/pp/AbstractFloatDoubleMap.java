...
implements FloatDoubleMap {
	...
	public Set<Entry<Float, Double>> entrySet() {
		...
		if(entrySet == null) {
			entrySet = new AbstractSet<Entry<Float, Double>>() {
	 ...
	 */
	public Set<PrimitiveEntryK<Double>> floatKeyEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(FloatMap<Double> map) {
		Iterator<FloatMap.PrimitiveEntryK<Double>> i;
		
		i = map.floatKeyEntrySet().iterator();
		while(i.hasNext()) {
			FloatMap.PrimitiveEntryK<Double> e = i.next();
	 ...
	 */
	public Set<PrimitiveEntryV<Float>> doubleValueEntrySet() {
		final Set<PrimitiveEntry> e = primitiveEntrySet();
	...
	public void putAllElement(DoubleValueMap<Float> map) {
		Iterator<DoubleValueMap.PrimitiveEntryV<Float>> i;
		
		i = map.doubleValueEntrySet().iterator();
		while(i.hasNext()) {
			DoubleValueMap.PrimitiveEntryV<Float> e = i.next();
	 ...
	 */
	public Double put(Float key, Double value) {
		return putElement(key.floatValue(), value.doubleValue());
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof FloatDoubleMap) {
			FloatDoubleMap m = (FloatDoubleMap)obj;
			Iterator<PrimitiveEntry> i;
