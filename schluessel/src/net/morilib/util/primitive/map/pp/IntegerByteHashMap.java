 ...
 */
public class IntegerByteHashMap
extends AbstractIntegerByteMap
implements java.io.Serializable {
	...
	private static class Ent implements PrimitiveEntry {
		...
		//
		private Ent(int key, byte value) {
			this.key   = key;
			this.value = value;
		}
		...
		//
		private Object putEntry(int k, Byte v) {
			Ent g = this;
	 ...
	 * @param loadFactor
	 */
	public IntegerByteHashMap(int initialCapacity, float loadFactor) {
		int cp = 1;
	 ...
	 * @param initialCapacity
	 */
	public IntegerByteHashMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public IntegerByteHashMap(float loadFactor) {
		this(16, loadFactor);
	}
	 ...
	 */
	public IntegerByteHashMap(IntegerByteMap mp) {
		this(16, 0.75f);
		putAllElement(mp);
	}
	 ...
	 */
	public Set<IntegerByteMap.PrimitiveEntry> primitiveEntrySet() {
		if(entrySet == null) {
			entrySet = new AbstractSet<PrimitiveEntry>() {
				...
				public int size() {
					return IntegerByteHashMap.this.size();
				}
	...
	//
	private boolean _putEntry(int k, Byte v) {
		int h = getHash(k) % ent.length;
